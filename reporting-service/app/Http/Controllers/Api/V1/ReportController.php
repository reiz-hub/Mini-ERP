...
class ReportController extends Controller
{
    ...
    public function summary(Request $request): JsonResponse
    {
        ...
        try {
            ...
            ])->timeout(5)->get(env('CRM_SERVICE_URL', 'http://localhost:8002') . '/api/v1/members');
        ...
        try {
            $membershipsResponse = Http::withHeaders([
                'Authorization' => $authHeader,
                'Accept'        => 'application/json',
            ])->timeout(5)->get(env('MEMBERSHIP_SERVICE_URL', 'http://localhost:8003') . '/api/v1/memberships');
        ...
        try {
            $expiringResponse = Http::withHeaders([
                'Authorization' => $authHeader,
                'Accept'        => 'application/json',
            ])->timeout(5)->get(env('MEMBERSHIP_SERVICE_URL', 'http://localhost:8003') . '/api/v1/memberships/expiring');
